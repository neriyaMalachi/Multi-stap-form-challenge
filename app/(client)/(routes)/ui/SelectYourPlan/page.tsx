...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <div className="h-[25%]  flex flex-col p-9 md:p-5 ">
        <h1 className="font-Ubuntu-Bold text-2xl">Select your plan</h1>
        <p className="mt-4 text-slate-400">
          You have the option of monthly or yearly billing.
        </p>
      </div>
      <div className="typesSelecte flex flex-col items-center h-[60%] md:flex-row md:h-[55%] md:w-[95%] md:m-4 justify-between  ">
        {Plans.map((plan, index) => {
          return (
            <div
              ...
              className={`flex items-center w-[85%] h-[30%] md:w-[30%] md:h-[80%] md:flex-col md:items-start md:justify-between  p-2 rounded-lg border border-slate-400  hover:border-blue-600 hover:bg-blue-50`}
            >
              <div className="h-16 ">
              ...
              <div className="flex flex-col ml-3 h-16">
                ...
                {user.yeare ? <p className="text-xs">2 months free</p> : <></>}
              </div>
            </div>
          );
        })}
      ...
      <div className="flex flex-col items-center   ">
        <label className="w-[85%] md:w-[96%] p-3 rounded-lg mt-4 inline-flex items-center justify-around cursor-pointer bg-slate-100 ">
